...
// JWTMiddleware.
type SuccessHandler func(next http.Handler, w http.ResponseWriter, r *http.Request, token string)
...
func DefaultSuccessHandler(next http.Handler, w http.ResponseWriter, r *http.Request, token string) {
	next.ServeHTTP(w, r)
	return
}
